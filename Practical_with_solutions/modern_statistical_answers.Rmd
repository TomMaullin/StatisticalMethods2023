...
The below code loads in a csv file containing data relating to diabetes progression. You can read more about this dataset [here](https://www4.stat.ncsu.edu/~boos/var.select/diabetes.html).
